...
VDPInitData:
  ...
  VDPDefineRegisterConstant 2, $08 ; 64x32 nametable each requiring two bytes = 4096 bytes, or $2000-$3000
  VDPDefineRegisterConstant 3, $0C ; Window nametable begins at $3000
  VDPDefineRegisterConstant 4, $02 ; 64x32 nametable each requiring two bytes = 4096 bytes, or $4000-$5000
  ...
  VDPDefineRegisterConstant 8, $00 ; Master System legacy registers always set to 0
  VDPDefineRegisterConstant 9, $00 ; Master System legacy registers always set to 0
